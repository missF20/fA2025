/*
  # Fix Subscription Data Structure

  1. New Tables
    - Ensure subscription_tiers exists with proper constraints
...
-- Ensure profiles table has subscription_tier_id column
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS idx_user_subscriptions_tier_id ON user_subscriptions(subscription_tier_id);
