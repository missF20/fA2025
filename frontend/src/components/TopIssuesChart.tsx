    ...
    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="relative">
            ...
            <AnimatePresence>
              {tooltipVisible === "help" && (
                ...
                >
                  Shows the most common issues reported by users, with frequency
                  and trend data
                </motion.div>
              )}
            </AnimatePresence>
      ...
      <div className="space-y-4">
        {issues.map((issue) => {
          ...
          const issueLabel =
            issue.issue || issue.name || `Issue #${issue.id || ""}`;
          ...
          return (
            <motion.div
              ...
              onClick={() =>
                setSelectedIssue(
                  selectedIssue === issueLabel ? null : issueLabel || null,
                )
              }
              ...
              {chartType === "progress" ? (
                <div className="w-full bg-gray-100 rounded-full h-3">
                  ...
                  >
                    ...
                    <div className="absolute right-0 -top-6 bg-gray-800 text-white text-xs px-1 py-0.5 rounded opacity-0 hover:opacity-100">
                ...
                <div className="h-20 w-full flex items-end space-x-1">
                  ...
                  {Array.from({
                    length: Math.min(10, Math.ceil(issue.percentage / 10)),
                  }).map((_, i) => (
                    <motion.div
                      key={i}
                      initial={{ height: 0 }}
                  ...
                  >
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-gray-900 font-medium">
                          {Math.round(issue.percentage)}% of all issues
                        </div>
                      </div>
                    </div>
