...
def add_direct_email_integration_routes():
    ...
    try:
        ...
        try:
            ...
            # We don't need to create a wrapper anymore since utils/csrf.py
            # now includes development mode detection and automatic bypass.
            # The updated csrf.py module will handle all the development mode checks
