"""
Direct Email Integration Fix V6
...
This version fixes the column name mismatch using "integration_type" instead of "type"
"""
...
def add_direct_email_integration_routes():
    ...
    try:
        # Import Flask app
        from main import app, token_required, get_user_from_token, csrf_enabled
