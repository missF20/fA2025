#!/usr/bin/env python3
"""
Fix Knowledge Management System Directly

This script directly adds crucial knowledge management endpoints to the main application,
bypassing the blueprint registration system which may be failing.
"""
import sys
import logging
...
def fix_knowledge_endpoints():
    """
    Add direct knowledge endpoints to main application
    """
    logger.info("Starting direct knowledge endpoint registration")
    ...
    try:
        ...
        # Add direct endpoint for getting knowledge file tags
        ...
        # Add direct endpoint for file listing
        ...
        # Add direct endpoint for file upload
        ...
        print("✅ Knowledge management endpoints successfully registered to main application.")
        
        return True
    except Exception as e:
        logger.error(f"Failed to register knowledge endpoints: {str(e)}")
        print(f"❌ Error registering knowledge endpoints: {str(e)}")
        return False

if __name__ == "__main__":
    # Execute the fix
    fix_knowledge_endpoints()