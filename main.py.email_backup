...
# Removed email integration code as requested
logger.info("Email integration modules removed as requested")
...
# Removed email endpoint 'direct_email_connect' as requested
...
# Removed email endpoint 'direct_email_disconnect' as requested
...
# Removed email endpoint 'test_email_direct_v2' as requested
...
# Removed email endpoint 'connect_email_direct_legacy' as requested
...
# Removed email endpoint 'send_email_direct' as requested
...
# Removed orphaned return statement: return send_email()
        else:
            # For regular tokens, use the normal auth process
            from utils.auth import token_required_impl
            ...
            if isinstance(auth_result, tuple):
                # Auth failed, return the error response
# Removed orphaned return statement: return auth_result
                
            # Call the original implementation which handles the request body extraction
# Removed orphaned return statement: return send_email()
    except Exception as e:
        logger.error(f"Error in direct email send endpoint: {str(e)}")
# Removed orphaned return statement: return jsonify({"success": False, "message": f"Email send API error: {str(e)}"}), 500
...
# Removed email endpoint 'get_email_status_direct' as requested
...
# Removed email endpoint 'connect_email_direct_v2' as requested
...
# Removed email endpoint 'get_email_configure_direct' as requested
...
# Removed email endpoint 'disconnect_email_direct' as requested
...
# Removed email endpoint 'email_integration_api_is_working_v2' as requested
...
# Removed email endpoint 'email_integration_status_check_v2' as requested
...
# Removed email endpoint 'email_integration_get_config_schema_v2' as requested
...
# Removed email endpoint 'email_integration_connect_service_v2' as requested
...
# Removed email endpoint 'email_integration_disconnect_service_v2' as requested
...
# Removed email endpoint 'direct_fix_email_disconnect' as requested
...
# Removed email endpoint 'direct_fix_email_connect' as requested
...
def direct_integrations_status():
    ...
    # Removed import from routes.integrations.routes (by migration 005_update_main_imports)
    slack_status = None # Removed call to test file or direct fix (by migration 005_update_main_imports)
    integrations.append({
        'id': 'slack',
...
# Removed email endpoint 'toggle_email_connect' as requested
...
# Use the centralized integration registration system (added by migration 005_update_main_imports)
try:
    # Import the migration manager to register integrations
    ...
    # Register standard integration blueprints
    migration_manager.run_migration_by_name(
        'integration_standardization', 
        '001_create_centralized_registration'
    )
    logger.info("Registered standard integration blueprints via migration manager")
except Exception as e:
    logger.error(f"Error registering standard integration blueprints: {str(e)}")
# Updated email disconnect endpoint
# Removed email endpoint 'toggle_email_disconnect' as requested
