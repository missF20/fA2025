...
Direct routes for file uploads without using blueprints.
"""
...
def register_file_routes(app):
    """Register file upload routes directly with the app"""
    ...
    @app.route('/api/files/test-upload', methods=['GET'])
    ...
    logger.info("File upload routes registered successfully")