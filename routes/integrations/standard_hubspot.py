...
hubspot_standard_bp = Blueprint(f'standard_{INTEGRATION_TYPE}_integration', __name__)

# Mark all routes as CSRF exempt for API endpoints
hubspot_standard_bp.decorators = [csrf_exempt]

@hubspot_standard_bp.route(f'/api/v2/integrations/{INTEGRATION_TYPE}/connect', methods=['POST', 'OPTIONS'])
...
@hubspot_standard_bp.route(f'/api/v2/integrations/{INTEGRATION_TYPE}/disconnect', methods=['POST', 'OPTIONS'])
...
@hubspot_standard_bp.route(f'/api/v2/integrations/{INTEGRATION_TYPE}/status', methods=['GET', 'OPTIONS'])
...
@hubspot_standard_bp.route(f'/api/v2/integrations/{INTEGRATION_TYPE}/sync', methods=['POST', 'OPTIONS'])
...
@hubspot_standard_bp.route(f'/api/v2/integrations/{INTEGRATION_TYPE}/test', methods=['GET', 'OPTIONS'])
